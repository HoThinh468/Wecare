...
class SetupGoalWeeklyRecordsWhenCreateNewGoalUsecase @Inject constructor(
    ...
    suspend fun setup(
        numberOfWeek: Int, latestGoalId: String, weeklyGoalWeight: Float, weeklyGoalCalories: Int
    ) {
        val weeklyRecords = getListOfWeeklyRecordsWithCurrentTimeAndNumberOfWeek(
            System.currentTimeMillis(), numberOfWeek, weeklyGoalWeight, weeklyGoalCalories
        )
